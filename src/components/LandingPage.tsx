...
const LandingPage = () => {
  return (
    <>
      <Head>
        <title>Kallmi Estate | Premium Albanian Extra Virgin Olive Oil</title>
        <meta name="description" content="Experience the finest cold-pressed, extra virgin olive oil from Albania's pristine Kallmi coast. A family legacy of artisanal olive oil craftsmanship since 1923." />
        <meta name="keywords" content="premium olive oil, Albanian olive oil, extra virgin olive oil, cold pressed olive oil, Mediterranean olive oil, Kallmi Estate, organic olive oil, artisanal olive oil" />
        <meta property="og:title" content="Kallmi Estate | Premium Albanian Extra Virgin Olive Oil" />
        <meta property="og:description" content="Experience the finest cold-pressed, extra virgin olive oil from Albania's pristine Kallmi coast. A family legacy of artisanal olive oil craftsmanship since 1923." />
        <meta property="og:image" content="/images/hero-3rd.webp" />
          ...
          {`
            {
              ...
              "description": "Premium cold-pressed extra virgin olive oil from Albania",
              "brand": {
                "@type": "Brand",
                "name": "Kallmi Estate"
              },
